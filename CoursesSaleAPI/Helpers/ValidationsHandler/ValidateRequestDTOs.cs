    ...
    public class ValidateRequestDTOs : IActionFilter
    {
        public void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            if (model.ErrorCount > 0)
                ...
                throw new CustomException(ConstantsErrors.VALIDATION_ERROR, model?.Values.FirstOrDefault(v => v.ValidationState == ModelValidationState.Invalid).Errors?.FirstOrDefault()?.ErrorMessage);
        }
